...
const ResumeBox = () => (
  <div className="relative rounded-3xl bg-white/20 backdrop-blur-lg border border-white/30 shadow-2xl p-8 w-full flex flex-col items-center overflow-visible">
